...
// import ReviewList from "./ReviewList";
// import ImageSlider from "../../common/ImageSlider";
// import { FaBath, FaBed, FaCar, FaMapMarkerAlt } from "react-icons/fa";
// import { MdOutlineHomeMini } from "react-icons/md";
...
//             </div>
//             <FiHeart
//               className={`text-2xl ${isFavourite ? "text-red-500" : "text-orange-400"}`}
//               onClick={handleFavouriteClick}
//             />
//           </div>
//           <p className="text-gray-600 mt-4">{properties?.data?.description}</p>
...
//               {/* PROPERTY DETAILS */}
//               <h3 className="my-8 font-bold text-lg">Property Details</h3>
//               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
//                 <div>
//                   <div className="border-2 border-gray-300 rounded-full p-4 mr-2 inline-flex">
...
//                 <div>
//                   <div className="border-2 border-gray-300 rounded-full p-4 mr-2 inline-flex">
//                     <FaBath className="text-md text-gray-700" />
//                   </div>
//                   <p className="text-gray-700 font-semibold">
...
//                 <div>
//                   <div className="border-2 border-gray-300 rounded-full p-4 mr-2 inline-flex">
//                     <MdOutlineHomeMini className="text-md text-gray-700" />
//                   </div>
//                   <p className="text-gray-700 font-semibold">
//                     {property.number_of_floors || 0} Floors
//                   </p>
//                 </div>
//                 <div>
//                   <div className="border-2 border-gray-300 rounded-full p-4 mr-2 inline-flex">
//                     <FaCar className="text-md text-gray-700" />
//                   </div>
//                   <p className="text-gray-700 font-semibold">
//                     {property.number_of_carspaces || 0} Carspaces
//                   </p>
//                 </div>
//                 <div>
//                   <div className="border-2 border-gray-300 rounded-full p-4 mr-2 inline-flex">
//                     <FaKitchenSet className="text-md text-gray-700" />
//                   </div>
//                   <p className="text-gray-700 font-semibold">
//                     {property.number_of_kitchens || 0} Kitchens
//                   </p>
//                 </div>
//               </div>
...
//                   >
//                     <Link to={`/properties/${relatedProperty.id}`}>
//                       <img
//                         src={
//                           relatedProperty.property_images[0]?.url ||
//                           DEFAULT_IMAGE
//                         }
//                         alt={relatedProperty.property_type.name}
