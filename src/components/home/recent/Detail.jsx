            ...
            <div className="max-w-6xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="p-6 md:p-10">
                    <h1 className="text-3xl font-bold text-gray-800">
                        {property?.property_type?.name || "Beautiful Family House"}
                    </h1>
                    ...
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <ul className="list-disc list-inside text-gray-600 mt-2">
                                {properties.data?.reviews?.length === 0 && <li>No reviews yet</li>}
                    ...
                    <div className="mt-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4">
                            {properties.data?.related_properties?.map((relatedProperty) => (
                                <Link to={`/property/${relatedProperty.id}`} key={relatedProperty.id}>
                                    <div className="bg-white border-2 rounded-lg overflow-hidden">
                                        <img
                                            src={relatedProperty.property_images.length > 0 ? relatedProperty.property_images[0].image : "https://via.placeholder.com/640x480.png"}
                                            alt="Property"
                                            className="w-full h-48 object-cover"
                                        />
                                        <div className="p-4">
                                            <h3 className="text-lg font-semibold">{relatedProperty.property_type?.name}</h3>
                                            <p className="text-gray-600">{relatedProperty.property_location.city.name}, {relatedProperty.property_location.district.name}</p>
                                            <p className="text-gray-800 mt-2">${relatedProperty.price}</p>
                                            <div className="bg-orange-100 px-3 py-2 mt-3 w-[8rem] rounded-md font-bold text-orange-400">
